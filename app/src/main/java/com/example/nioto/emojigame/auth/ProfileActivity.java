...
public class ProfileActivity extends BaseActivity {
    ...
    public void getToolbarViews() {
        ...
        this.buttonCoinsToolbar = findViewById(R.id.profile_activity_toolbar_coins_button);
        this.buttonSmileysToolbar = findViewById(R.id.profile_activity_toolbar_smileys_button);
            ...
            mImageRef.putFile(this.uriImageSelected)
                    .addOnSuccessListener(this, new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Task<Uri> urlTask = Objects.requireNonNull(Objects.requireNonNull(taskSnapshot.getMetadata()).getReference()).getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                                @Override
                                public void onComplete(@NonNull Task<Uri> task) {
                                    String pathImageSavedInFirebase = Objects.requireNonNull(task.getResult()).toString();
